%% Title: Local and Global Analysis of Spatiotemporal Patterning in Leaves
%% Author: Joshua Moore
%% Description: 
%  This program takes lucifrase expression data in the form of a .mat file. This data is then transformed into phases 
%  using the Pikovsky method and analysed using local Moran's I, local Geary's C, Moran scatter plots and global measures of spatial
%  autocorrelation and synchrony. In addition to this, example calculations of local Moran and local Geary are presented for 
%  three different scenarios.
%  Due to large number of iterations, the program is slowed by significance
%  calculations. Comment lines 1226:1456 for faster figures without
...
if isfile(fullfile(pwd,'breakxaxis.m')) && isfile(fullfile(pwd,'breakyaxis.m'))
    ...
    %% To select different leave change the numbers in the square brackets e.g. for leaf 16 use for number = [16]
    for numbers = 21
        if isfile(leaffile)
...
%             
            ...
            %% Syncrhony Measures Calculation
            % Initialise Measures
            ...
            if (skipPart) == 'y' || (skipPart) == 'Y'
                ...
                for m = 1:length(LocalMI(1,1,:))
                    ...
                    if numbers == 17
                        nbins = 30; % Figure looks better with higher bins for 17
                    else
                        nbins = 20;
                    end
                    ...
                    for t = 1:length(LISArand(:,1,1))
                        for k = 1:length(LISArand(1,:,1))
                            if leaf(t,k) == 1
                                ...
                                if (k == 21 && t == 14 && m == 1 && numbers == 17) || (k == 13 && t == 36 && m == 1 && numbers == 20) ...
                                        || (k == 18 && t == 12 && m == 1 && numbers == 16) || (k == 18 && t == 12 && m == 1 && numbers == 11) % Different cells used for each of the four leaves considered in the study
                                    ...
                                    if numbers == 17
                                        xlim([-3 3]) % Wider xlim for 17 to capture all conditions
                                    else
                                    ...
                                    if numbers == 17
                                        text(-2.9,450,'1','interpreter','latex','FontSize',25)  % Insert cell label (different location for 17
                                    else
                                ...
                                elseif (k == 30 && t == 24 && m == 1 && numbers == 17) || (k == 28 && t == 45 && m == 1 && numbers == 20) ...
                                        || (k == 10 && t == 20 && m == 1 && numbers == 16) || (k == 25 && t == 18 && m == 1 && numbers == 11) % Different cells used for each of the four leaves considered in the study
                                    subplot(2,12,[9 12])
                                    d=histogram(temp',nbins,'FaceColor','w','LineWidth',2); % Plot histogram of local Moran values
                                    hold on
                                    y = pdf(pd,xvals);  % y values of pdf at xvals
                                    ...
                                    plot(ones(size(yvals)).*LocalMI(t,k,m),yvals,'r','LineWidth',4) % Plot actual local Moran value
                                    if numbers == 17
                                        text(-2.9,450,'2','interpreter','latex','FontSize',25)
                                    else
                                ...
                                elseif (k == 14 && t == 24 && m == 1 && numbers == 17) || (k == 20 && t == 28 && m == 1 && numbers == 20) ...
                                        || (k == 25 && t == 28 && m == 1 && numbers == 16) || (k == 15 && t == 25 && m == 1 && numbers == 11) % Different cells used for each of the four leaves considered in the study
                                    subplot(2,12,[16 19])
                                    ...
                                    plot(ones(size(yvals)).*LocalMI(t,k,m),yvals,'r','LineWidth',4) % Plot actual local Moran value
                                    if numbers == 17
                                        text(-2.9,450,'3','interpreter','latex','FontSize',25)
                                    else
                                ...
                                elseif (k == 24 && t == 26 && m == 1 && numbers == 17) || (k == 23 && t == 53 && m == 1 && numbers == 20)...
                                        || (k == 19 && t == 32 && m == 1 && numbers == 16) || (k == 28 && t == 27 && m == 1 && numbers == 11) % Different cells used for each of the four leaves considered in the study
                                    subplot(2,12,[21 24])
                                    d=histogram(temp',nbins,'FaceColor','w','LineWidth',2); % Plot histogram of local Moran values
                                    hold on
                                    y = pdf(pd,xvals);  % y values of pdf at xvals
                                    ...
                                    if numbers == 17
                                        text(-2.9,450,'4','interpreter','latex','FontSize',25)
                                    else
                                    ...
                                    if numbers ~= 11
                                        ...
                                        text(k-2,t-1,'4','interpreter','latex','FontSize',25) % Due to location of leaf 11 4th cell, place label to left
                                    end
                                    subplot(2,12,[1 2 13 14])
                                    Clusters = leaf;
                                    ...
                                    if numbers==17
                                        tb.Position(1) = x1-10; % Adjust x coordinate of b label
                                    else
            ...
            SignficanceAtT = Significance(:,:,end); % If cells significant for all time are desired: remove "(:,:,end)" and average through time e.g. nanmean(Significance,3).
            ...
            figure(200 + leafn)
            VidName = ['Video',num2str(numbers),'.mp4']; % Define video name = Video + leaf number
...
%         time point
%% Output:
% KuramotoOrderParameter: Kuramoto order parameter, KuramotoOrderParameter. KuramotoOrderParameter = 1 is perfect syncrhony. KuramotoOrderParameter = 0 is complete asyncrhony.
